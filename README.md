...
애견 키워드 이미지 검색, 후보 선별, 효과 다운로드를 한 화면에서 처리하는 Next.js 기반 작업 앱입니다.

## 주요 기능

### 이미지 검색 및 다운로드
- **애견 키워드 검색**: 품종명, 산책 장면, 분양 키워드 등으로 빠르게 검색
- **프리셋 시작점**: 자주 쓰는 애견 키워드를 첫 화면에서 바로 선택
